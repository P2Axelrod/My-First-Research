...
class KPConv(nn.Module):
    ...
    def forward(self, q_pts, s_pts, neighb_inds, x):
        ...
        # print("q_pts.shape = {}".format(q_pts.shape))
        # print("s_pts.shape = {}".format(s_pts.shape))
        # print("neighb_inds.shape = {}".format(neighb_inds.shape))
        ###################
        # Offset generation
        ###################
        ...
        # print("s_pts.shape = {}".format(s_pts.shape))
        # print("q_pts.shape = {}".format(q_pts.shape))
        # Add a fake point in the last row for shadow neighbors (通过加在最后一行很大的x,y,z使得这个点在conv的时候被忽略)
...
class SimpleBlock(nn.Module):
    ...
    def forward(self, x, batch):
        ...
        # print("neighb_inds = {}".format(neighb_inds))
...
class NearestUpsampleBlock(nn.Module):
    ...
    def forward(self, x, batch):
        # print("batch = {}".format(batch.upsamples[self.layer_ind - 1].shape))
